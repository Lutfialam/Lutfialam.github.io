    ...
    <div className='dark:bg-gray-900'>
      ...
      <div className='fixed h-screen hidden sm:flex flex-col space-y-6 justify-end px-6 py-10 z-30'>
        ...
        <Dropdown
          ...
          paragraph={
            <p>
              If you want contact me. You can meet me on telegram with username{' '}
        ...
        <Dropdown
          ...
          paragraph={
            <p>
              If you want contact me. You can meet me on linkedin with username{' '}
              <span className='text-indigo-500'>Lutfialamsyah</span>
            </p>
          }
        />
            ...
            <div className='flex justify-center w-full'>
              <div className='flex-col justify-center w-full md:w-2/4 self-center'>
                ...
                <p className='text-gray-600 mt-4 py-4'>
                  ...
                  have experienced in build and developing website and android
                  application(react native). For more than two years I have
                  created several website projects, some of which are for other
                  people's needs or for my experiments.
                </p>
                <div className='flex'>
                  <button
          ...
          >
            <div className='w-full md:w-1/2 flex justify-center md:justify-start flex-wrap content-center'>
              ...
              <p className='text-gray-500 self-center text-center md:text-left'>
                ...
                <span className='text-indigo-500'>lumah shop</span>. is a shoe
                store website in which there are sales of various shoes, ranging
                from sports, daily, school and others. This website is made
                using Java web with hibernate and JSF with bootstrap for the
                frontend. This website was created only for the purposes of my
                monthly college project
              </p>
          ...
          <div className='w-full flex'>
            <div className='flex flex-col w-2/5'>
              ...
              <p className='text-gray-500'>
                If you want talk or meet with me. you can contact me in several
                social media in right side of this paragraph
              </p>
            </div>
